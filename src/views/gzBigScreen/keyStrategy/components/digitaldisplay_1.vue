          ...
          <el-col :span="15">
            <div class="topDivP">
              <div class="ribanliliangkey">
                <span class="iconkeyfont ">当日携出量</span>
              </div>
              <el-row class="flex">
                <el-col :span="12" class="wid100">
                  <span class="iconvaluefont ribanliliangvalue">{{ result.orderAmountDay }}</span>
                </el-col>
                <el-col :span="12" class="wid100">
      ...
      <el-col :span="6">
        <el-row>
          ...
          <el-col :span="15">
            <div class="topDivP">
              <div class="ribanliliangkey">
                <span class="iconkeyfont ">日超目标</span>
              </div>
              <el-row>
                <el-col :span="12">
                  <span class="iconvaluefont ribanliliangvalue">{{ result.orderRateDay }}</span>
      ...
      <el-col :span="6">
        <el-row>
          ...
          <el-col :span="15">
            <div class="topDivP">
              <div class="ribanliliangkey">
                <span class="iconkeyfont ">当月累计携出量</span>
              </div>
              <el-row class="flex">
                <el-col :span="12" class="wid100">
      ...
      <el-col :span="6">
        <el-row>
          ...
          <el-col :span="15">
            <div class="topDivP">
              <div class="ribanliliangkey">
                <span class="iconkeyfont ">月超目标</span>
              </div>
              <el-row>
                <el-col :span="12">
