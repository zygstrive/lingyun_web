<template>
  <div>
    <el-row style="width:100%">
          ...
          <el-col :span="16">
            <div class="topDivP">
              <div class="ribanliliangkey">
                <span class="iconkeyfont ">当日新增办理量</span>
              </div>
              <el-row  class="flex">
                <el-col :span="14" class="wid100">
                  <span class="iconvaluefont">{{result.orderAmountDay || '-'}}</span>
                </el-col>
                <el-col :span="10" class="wid100">
      ...
      <el-col :span="8">
        <el-row>
          ...
          <el-col :span="16">
            <div class="topDivP">
              <div class="ribanliliangkey">
                <span class="iconkeyfont ">当月累计新增办理量</span>
              </div>
              <el-row class="flex">
                <el-col :span="12" class="wid100">
                  <span class="iconvaluefont">{{result.orderAmountMonth || '-'}}</span>
      ...
      <el-col :span="8">
        <el-row>
          <el-col :span="8" class="chartBox">
            <el-image class="iconImg ribanliliangiconImgDiv" :src="riwanchenglv"/>
            <div class="chart1" :id="'waterPoloChart'+boolId"></div>
          </el-col>
          <el-col :span="16">
            <div class="topDivP">
              <div class="ribanliliangkey">
                <span class="iconkeyfont ">月目标差距</span>
              </div>
              <el-row>
                <el-col :span="12">
                  <span class="iconvaluefont">{{result.orderRateMonth || '-'}}</span>
                  <span class="iconvaluefont2">pp</span>
                </el-col>
              </el-row>
            </div>
          </el-col>
