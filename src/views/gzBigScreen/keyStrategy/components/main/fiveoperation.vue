<template>
  <div class="bg">
    <div class="bg2">
      <span class="titleB">5G迁转</span>
      <digitaldisplay :result="result" bool-id="point1" class="box"></digitaldisplay>
      <div class="bg3">
        <span class="title3">
          办理量走势图
        </span>
      </div>
      <trend :trendList="trendListBar" :trendListLine="trendListLine" :thisMonthStr="thisMonthStr" :lastMonthStr="lastMonthStr" style="height: 53%;"></trend>
    </div>
  </div>
