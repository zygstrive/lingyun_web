<template>
  <div class="bg">
    <div class="bg2">
      <span class="titleB">携号转网</span>
      <digitaldisplay :result="result" bool-id="point8" class="box"></digitaldisplay>
      <div class="bg3">
        <span class="title3">
          办理量走势图
        </span>
...
<script>
  ...
  import digitaldisplay from '../digitaldisplay_1.vue'
